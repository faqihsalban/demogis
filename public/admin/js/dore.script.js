  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("categoryChart")) {
        ...
        if (document.getElementById("categoryChart40th")) {
            var categoryChart40th = document.getElementById("categoryChart40th");
            var myDoughnutChart = new Chart(categoryChart40th, {
                plugins: [centerTextPlugin],
                type: "DoughnutWithShadow",
                data: {
                    labels: ["Under 40th", "More 40"],
                    datasets: [
                        {
                            label: "",
                            borderColor: [themeColor3, themeColor2, themeColor1],
        ...
        if (document.getElementById("categoryChartFood")) {
            var categoryChartFood = document.getElementById("categoryChartFood");
            var myDoughnutChart = new Chart(categoryChartFood, {
                plugins: [centerTextPlugin],
                type: "DoughnutWithShadow",
                data: {
                    labels: ["Indonesian", "Western","Others"],
                    datasets: [
                        {
                            label: "",
                            borderColor: [themeColor3, themeColor2, themeColor1],
